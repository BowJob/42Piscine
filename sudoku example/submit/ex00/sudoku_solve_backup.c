...
{
	int i, j;
    //builds initial array, please replace with appropriate code to make and display array.
    //also remember to remove stdio.h from top when done.
    int grid[9][9]={{9, 0, 6, 0, 7, 0, 4, 0, 3},
                      {0, 0, 0, 4, 0, 0, 2, 0, 0},
                      {0, 7, 0, 0, 2, 3, 0, 1, 0},
                      {5, 0, 0, 0, 0, 0, 1, 0, 0},
                      {0, 4, 0, 2, 0, 8, 0, 6, 0},
